...
import styles from '/styles/integration/integration.module.scss';
...
const integration = () => {
  ...
  return (
    <div className={styles.entirePage}>
        ...
        <h2 className={styles.title}>Integrating your accounts...</h2>
        ...
        <div className={styles.rightSide}>
           ...
           <div className={styles.options}>
            <Button 
                    ...
                    >
                        <p >
                            <i className='bx bxs-plus-circle bx-spin-hover'></i>
                        </p>
                </Button>
