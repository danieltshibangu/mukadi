...
const handler = async (req, res) => {
            ...
            for (let i=0; i < checkingTokens.length; i++ ) {
                let curr_access_token = checkingTokens[i]
                ...
                for (let a=0; a < eachAccount; a++) {
                    ...
                    if (accountData.data.accounts[a].subtype == 'checking') {
                        ...
                        num_of_accounts++;
                        checking_total += accountData.data.accounts[a].balances.current
                    }
                }
           }
            ...
            res.json({
                total: dollarFormatUS.format(checking_total), 
